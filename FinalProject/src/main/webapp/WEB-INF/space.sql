...
alter table product add(good_count varchar2(3000));
alter table product add(review_count varchar2(3000));

alter table auctiontemp add(amenities varchar2(3000));
alter table auction add(amenities varchar2(3000));
