...
<body>
	<jsp:include page="/header.jsp" ><jsp:param value="'${fn:length(rplist)}' 건의 검색 결과" name="pageName"/></jsp:include>
<div style="height: 100px;"></div>
	...
	<form action="">
		...
		<table>
	<tr>
		<c:forEach items="${rplist }" var="space" varStatus="i" begin="0" end="5">
				<td>
	...
	<tr>
				...
				<c:forEach items="${rplist }" var="space" varStatus="i" begin="6" end="11">
				<td>
                        <div class="item" style="width : 250px; margin-right: 50px; margin-bottom: 50px;">
                            <div class="property clearfix" style="background-color: white; border-bottom: 2px solid #DCDCDC;">
                                <div class="image">
	...
	<tr>
				...
				<c:forEach items="${rplist }" var="space" varStatus="i" begin="12" end="17">
				<td>
                        <div class="item" style="width : 250px; margin-right: 50px; margin-bottom: 50px;">
                            <div class="property clearfix" style="background-color: white; border-bottom: 2px solid #DCDCDC;">
                                <div class="image">
	...
	<tr>
				...
				<c:forEach items="${rplist }" var="space" varStatus="i" begin="18" end="23">
				<td>
                        <div class="item" style="width : 250px; margin-right: 50px; margin-bottom: 50px;">
                            <div class="property clearfix" style="background-color: white; border-bottom: 2px solid #DCDCDC;">
                                <div class="image">
	...
	<tr>
				...
				<c:forEach items="${rplist }" var="space" varStatus="i" begin="24" end="29">
				<td>
                        <div class="item" style="width : 250px; margin-right: 50px; margin-bottom: 50px;">
                            <div class="property clearfix" style="background-color: white; border-bottom: 2px solid #DCDCDC;">
                                <div class="image">
	...
	<tr>
				...
				<c:forEach items="${rplist }" var="space" varStatus="i" begin="30">
				<td>
                        <div class="item" style="width : 250px; margin-right: 50px; margin-bottom: 50px;">
                            <div class="property clearfix" style="background-color: white; border-bottom: 2px solid #DCDCDC;">
                                <div class="image">
