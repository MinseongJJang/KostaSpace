...
<jsp:param value="휴테크등록양식" name="pageName"/>
</jsp:include>  
        ...
        <div class="container">
            ...
            <div class="content">
         <form action="${initParam.root}registerSpace.do" method="post" id="registerProductForm" 
         name="registerProductForm" class="property-submit-form" enctype="multipart/form-data" role="form">
            <input type="hidden" value="${param.licence}" name="licence">
               <div class="form-group">
                  
                  <input type="hidden" class="form-control" id="category" name="category" 
                     value="${param.space}" readonly="readonly">
                    </div>
                    <div class="form-group">
                  <label for="label-registerProduct">Type</label>
                  <input type="text" class="form-control" id="type" name="type" 
                     value="${param.type}" readonly="readonly">
               </div>
               
               <div class="form-group">
                  <label for="label-registerProduct">휴테크 이름</label>
                  <input type="text" class="form-control" id="title" name="title" 
                     required="required" placeholder="">
               </div>
               
               <div class="form-group">
                  <label for="label-registerProduct">휴테크 상세정보</label>
                  <textarea rows="22" cols="40" class="form-control" id="content" name="content"
                  placeholder="Content" required="required" style="resize: none"></textarea>
                  
               </div>
               <div class="input-group">
                  <label for="label-registerProduct">#해시태그</label><br>
                  <input type="text" class="form-control" id="hashtagInsert"  style="width:500px;" placeholder="예) #파티룸">
                  &nbsp;&nbsp;<span><input type="button" id="hashInsert" class="btn" value="추가" style="height: 80%; background-color: #004b8b; color: white" ></span>
                  <br><br><br>
                  <div id="hash"></div>
                  <input type="text" class="form-control" id="hashtag" name="hashtag" required="required" style="width: 500px;" readonly="readonly">&nbsp;&nbsp;
                  <span><input type="button" id="hashDelete" class="btn" value="전체삭제" style="height: 80%; background-color: #004b8b; color: white" ></span>
               </div>
               <div class="form-group" style="margin-top: 15px;">
                  <label for="label-registerProduct">시간당 가격</label>
                  <input type="text" class="form-control" id="price" name="price" placeholder="Price" 
                     required="required">
               </div>
               <div class="form-group">
                  <label for="label-registerSpaceUser">판매자번호</label>
               ...
               <div class="form-group">
                  <label for="label-registerProduct">주소</label>
                   ...
                   <div class="input-group" >
                               ...
                               <input type="text" class="form-control" name="area" id="sample5_address" placeholder="주소" style="width:522px">
                               <span>&nbsp;&nbsp;&nbsp;<input type="button" onclick="sample5_execDaumPostcode()" class="btn btn-red" value="주소검색" style="height: 80%;background-color: #004b8b; color: white"></span>
                               <input type="text" class="form-control" name="location" id="sample5_address" placeholder="상세주소" style="width:80%"></div>
        ...
        new daum.Postcode({
            oncomplete: function(data) {
               ...
               <div >         
                     ...
                     <select id="eTime" name="eTime" style="height: 40px;">
                     <option>==========</option>
                     <option>01:00</option>
                     <option>02:00</option>
                     <option>03:00</option>
               ...
               <br><br>
               <input type="submit" value="작성" onsubmit="check()" class="btn" style="background-color: #004b8b; color: white">
               <input type="reset" value="재입력" class="btn" style="background-color: #004b8b; color: white">
