...
public class AuctionTempVO {
	...
	public AuctionTempVO() {
		super();
	}

	public AuctionTempVO(int a_no, String price, String content, String area, MultipartFile upload, String location,
			String tel, String crn, String a_date, String confirm, String title, String originfilename,
			String newfilename, String id, String name, String enddate, String accomodation, String aoriginfilename,
			String anewfilename, MultipartFile aupload, String amenities, PagingBean pb) {
		super();
		this.a_no = a_no;
		this.price = price;
	...
	public String toString() {
		return "AuctionTempVO [a_no=" + a_no + ", price=" + price + ", content=" + content + ", area=" + area
				+ ", upload=" + upload + ", location=" + location + ", tel=" + tel + ", crn=" + crn + ", a_date="
				+ a_date + ", confirm=" + confirm + ", title=" + title + ", originfilename=" + originfilename
				+ ", newfilename=" + newfilename + ", id=" + id + ", name=" + name + ", enddate=" + enddate
				+ ", accomodation=" + accomodation + ", aoriginfilename=" + aoriginfilename + ", anewfilename="
				+ anewfilename + ", aupload=" + aupload + ", amenities=" + amenities + ", pb=" + pb + "]";
	}
